...
public class Azafata extends Empleado{
    ...
    public Azafata() {
     ...
     public Azafata(String nombre, String apellido, String contacto, String email, int edad, String documentos, String rol, String codigo
    ...
    public void MostrarInformacionAzafata(){
